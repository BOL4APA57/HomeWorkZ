...
# (от 5 до 10).
# Для этого найдите подходящую функцию из модуля random. Затем сгенерируйте третий список,
...
#todo 1) нельзя называть функции зарезервированными именами, list - зарезервированное имя
# 2) функция list должна быть записана в виде листкомпрехеншонс
