...
# У нас есть случайная выборка из десяти номеров. Правда, иногда база глючит и выдаёт нам номер с отрицательным значением.
...
for _ in range(10):
    ...
    if num > 0 and num % 2 == 0:
        count += 1
print('Из введенных чисел условию соответствуют', count)