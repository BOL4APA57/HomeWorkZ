...
# налоговая ставка 30% на доход выше 50 000 означает, что 30% уплачивается не со всей суммы, а лишь с той её части, которая превосходит 50 000.
# Аналогично ставка 20% на доход от 10 000 до 50 000 обязывает уплатить 20% лишь с той части суммы, которая превосходит 10 000, но не превосходит 50 000.
...
money = int(input('Введите сумму вашего дохода: '))

if money < 10000:
    print('Сумма налога составляет: ', money * 0.13)
elif 10000 <= money < 50000:
    print('Сумма налога составляет: ', (money - 10000) * 0.2 + 1300)
else:
    print('Сумма налога составляет: ', (money - 50000) * 0.3 + 9300)