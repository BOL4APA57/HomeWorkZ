...
films = ["КРЕПКИЙ ОРЕШЕК", "НАЗАД В БУДУЩЕЕ", "ТАКСИСТ", "ЛЕОН", "БОГЕМСКАЯ РАПСОДИЯ", "ГОРОД ГРЕХОВ", "МЕМЕНТО", "ОТСТУПНИКИ", "ДЕРЕВНЯ"]
favor = []
num = input("Сколько фильмов хотите добавить?")

while not num.isnumeric():
    num = input("Ошибка! Введенное число должно быть натуральным.\nПовторите ввод: ")

for _ in range(int(num)):
    select_film = input("Введите название фильма:")
    if select_film.upper() in films:
        favor.append(select_film.capitalize())
    else:
        print(f"Ошибка: фильма {select_film} у нас нет :(")
print("Ваш список любимых фильмов:", *favor)
