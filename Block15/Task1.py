...
first = [1, 5, 1, 5]
second = [1, 3, 1, 5, 3, 3]
#TO DO не злоупотребляй групповым присваиванием, лучше записать в столбик, читать легче будет
# check/ Done

ls.extend(first)
print("Кол-во цифр 5 при первом объединении:", ls.count(5))
while 5 in ls:
    ls.remove(5)
ls.extend(second)
print("Кол-во цифр 3 при втором объединении:", ls.count(3))
print("Итоговый список:", ls)
#TO DO Итоговый список не верный, тут явно чего-то не хвататет
# Check/ Done Невнимательно прочитал задание.
#ЗачОт